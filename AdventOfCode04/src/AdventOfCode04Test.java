...
public class AdventOfCode04Test {
    ...
    @Test
    public void start04Test() {
        AdventOfCode04 adventOfCode04 = new AdventOfCode04();

        String input = new String("[1518-05-27 00:42] falls asleep\n" +
        ...
        int result = adventOfCode04.start04(input);

        Assert.assertEquals(result, 100353);
